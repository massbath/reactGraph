  ...
  render() {
    ...
    return (
      <FormGroup>
        ...
        <Col sm={controlSize}>{this.props.children}</Col>
      </FormGroup>
    )
  }
}
...
export class ActionRowTable extends React.Component {
  ...
  render() {
    return (
      <div>
        {this.props.showActionMoveUp && (
          <Glyphicon
            glyph="menu-up"
            onClick={() => this.props.actionMove('up')}
          />
        )}
        {this.props.showActionMoveDown && (
          <Glyphicon
            glyph="menu-down"
            onClick={() => this.props.actionMove('down')}
          />
        )}
...
export class DownloadButton extends React.Component {
  ...
  onClickCallback() {
    ...
    fileDownload(
      JSON.stringify(this.props.dataToDownload),
  ...
  render() {
    return (
      <Button onClick={() => this.onClickCallback()}>
        {this.props.label} <Glyphicon glyph="save" />
      </Button>
    )
  }
}
